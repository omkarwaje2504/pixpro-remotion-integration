...
export async function GET() {
  try {
    const data = {
      ...
      "company_logo": "https://pixpro.s3.ap-south-1.amazonaws.com/production/files/2024/01/BUZY2brFFEvcrMz6nn9cEnKXF9Hkdk5hJfLWKJHZ.jpg",
      ...
      "cropperFields": [],
      "top_banner": "https://pixpro.s3.ap-south-1.amazonaws.com/production/files/2025/03/ecZbGFweJkOnrq3DHvOVyrJl8tOvvBkTATvQY1CH.jpg",
      "bottom_banner": "",
      "logo": "https://pixpro.s3.ap-south-1.amazonaws.com/production/files/2025/03/zlnzJFPOODAWiWIOECmLttolprdukaA7802EAnSI.jpg",
      "features": [
        "default_employee"
      ],
      "fields": {
      ...
      "web_link": "https://indchemie.pixpro.app/mothers-day-2025",
      "settings": {
        ...
        "external_domain": "https://studio.pixpro.app/k4qw1jng",
        "password": null,
        "report_column": "hq",
        "approval_stage": null,
        "primaryColor": null,
    ...
    console.error("API Error:", error.message); // This will print in terminal
